...
object RadixElement {
  ...
  implicit val Strings: RadixElement[String] = new RadixElement[String] {
    def byteAt(str: String, pos: Int): Int =
      if (pos >= str.length*2) -1 else (str.charAt(pos/2) >> ((~pos & 1) * 8)) & 0xff
  ...
  val ASCIIStrings: RadixElement[String] = new RadixElement[String] {
    def byteAt(str: String, pos: Int): Int =
      if (pos >= str.length) -1 else str.charAt(pos) & 0xff
  ...
  implicit val UnsignedByteArrays: RadixElement[Array[Byte]] = new RadixElement[Array[Byte]] { self =>
    ...
    def sort(arr: Array[Array[Byte]], len: Int, depth: Int): Unit =
      RadixQuicksort.sort[Array[Byte]](arr, 0, len, depth)(self)
      //Arrays.sort(arr, 0, len, byteArrayComparator)

    val classTag: ClassTag[Array[Byte]] = implicitly[ClassTag[Array[Byte]]]
  }

  val SignedByteArrays: RadixElement[Array[Byte]] = new RadixElement[Array[Byte]] { self =>
    def byteAt(str: Array[Byte], pos: Int): Int =
  ...
  implicit val IntArrays: RadixElement[Array[Int]] = new RadixElement[Array[Int]] {
    ...
    def sort(arr: Array[Array[Int]], len: Int, depth: Int): Unit = RadixQuicksort.sort(arr, 0, len, depth)
  ...
  implicit val LongArrays: RadixElement[Array[Long]] = new RadixElement[Array[Long]] {
    ...
    def sort(arr: Array[Array[Long]], len: Int, depth: Int): Unit = RadixQuicksort.sort(arr, 0, len, depth)
  ...
  implicit def Options[T](implicit el: RadixElement[T]) = new RadixElement[Option[T]] { self =>
  ...
  implicit def Eithers[A, B](implicit ela: RadixElement[A], elb: RadixElement[B]) = new RadixElement[Either[A, B]] { self =>
